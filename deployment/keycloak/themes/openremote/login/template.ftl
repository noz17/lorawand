                    ...
                    <div class="row">
                        <div class="col s12 center">
                            <div id="header-wrapper">
                                <a id="logo" href="https://WWW.fablabjababeka.com/">
                                    <img src="${url.resourcesPath}/img/lorawand-logo.png" height="105px" width"291px">
                                </a>
                                <div class="left-align">
                                   <!-- <h5 id="header"><#nested "header"></h5><br>
                                     <p id="sub-header">LORAWAND</p2> -->
                                </div>
                            </div>
                        </div>
                    </div>
